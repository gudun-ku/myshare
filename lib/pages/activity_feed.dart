...
Widget mediaPreview;
String activiyItemText;

class ActivityFeedItem extends StatelessWidget {
  //use as both the model and widget
  ...
  configureMediaPreview() {
    if (type == "like" || type == "comment") {
      mediaPreview = GestureDetector(
        onTap: () => print('showing post in full size'),
        child: Container(
          height: 50.0,
          width: 50.0,
          child: AspectRatio(
    ...
    if (type == "like") {
      ...
      activiyItemText = "Error: Unknown type, '$type";
    }
  }
